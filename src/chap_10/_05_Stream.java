...
public class _05_Stream {
    public static void main(String[] args) {
        ...
        //Stream.of()
        Stream<String> langistOfStream = Stream.of("python", "java", "javascript", "c", "c++", "c#");


        //스트림 사용
        //중간 연산 (Intermediate Operatiion) > 정수기 필터 : filter, map, sorted, distinct, skip
        //최종 연산(Terminal Operation) > 최종적으로 나와지는 결과물 count, min, max
